...
_lr_productions = [
  ...
  ('group -> terminal_sequence MINUS terminal_sequence group','group',4,'p_group','frontend_pythonre.py',188),
  ('group -> terminal_sequence MINUS terminal_sequence','group',3,'p_group','frontend_pythonre.py',189),
  ('group -> terminal_sequence group','group',2,'p_group','frontend_pythonre.py',190),
  ('group -> terminal_sequence','group',1,'p_group','frontend_pythonre.py',191),
  ('group -> metachar group','group',2,'p_group','frontend_pythonre.py',192),
  ('group -> metachar','group',1,'p_group','frontend_pythonre.py',193),
  ('terminal_sequence -> CHAR','terminal_sequence',1,'p_terminal_sequence','frontend_pythonre.py',237),
  ('terminal_sequence -> NUM','terminal_sequence',1,'p_terminal_sequence','frontend_pythonre.py',238),
  ('terminal_sequence -> HEXA','terminal_sequence',1,'p_terminal_sequence','frontend_pythonre.py',239),
  ('terminal_sequence -> COMMA','terminal_sequence',1,'p_terminal_sequence','frontend_pythonre.py',240),
  ('metachar -> WHITESPACE','metachar',1,'p_metachar','frontend_pythonre.py',250),
  ('metachar -> WHITESPACE_COMPLEMENTED','metachar',1,'p_metachar','frontend_pythonre.py',251),
  ('metachar -> DIGIT','metachar',1,'p_metachar','frontend_pythonre.py',252),
  ('metachar -> DIGIT_COMPLEMENTED','metachar',1,'p_metachar','frontend_pythonre.py',253),
  ('metachar -> ALPHANUMERIC','metachar',1,'p_metachar','frontend_pythonre.py',254),
  ('metachar -> ALPHANUMERIC_COMPLEMENTED','metachar',1,'p_metachar','frontend_pythonre.py',255),
]
