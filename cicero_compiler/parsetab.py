...
_lr_productions = [
  ...
  ('group -> terminal_sequence MINUS terminal_sequence group','group',4,'p_group','frontend_pythonre.py',168),
  ('group -> terminal_sequence MINUS terminal_sequence','group',3,'p_group','frontend_pythonre.py',169),
  ('group -> terminal_sequence group','group',2,'p_group','frontend_pythonre.py',170),
  ('group -> terminal_sequence','group',1,'p_group','frontend_pythonre.py',171),
  ('group -> metachar group','group',2,'p_group','frontend_pythonre.py',172),
  ('group -> metachar','group',1,'p_group','frontend_pythonre.py',173),
  ('terminal_sequence -> CHAR','terminal_sequence',1,'p_terminal_sequence','frontend_pythonre.py',217),
  ('terminal_sequence -> NUM','terminal_sequence',1,'p_terminal_sequence','frontend_pythonre.py',218),
  ('terminal_sequence -> HEXA','terminal_sequence',1,'p_terminal_sequence','frontend_pythonre.py',219),
  ('terminal_sequence -> COMMA','terminal_sequence',1,'p_terminal_sequence','frontend_pythonre.py',220),
  ('metachar -> WHITESPACE','metachar',1,'p_metachar','frontend_pythonre.py',230),
  ('metachar -> WHITESPACE_COMPLEMENTED','metachar',1,'p_metachar','frontend_pythonre.py',231),
  ('metachar -> DIGIT','metachar',1,'p_metachar','frontend_pythonre.py',232),
  ('metachar -> DIGIT_COMPLEMENTED','metachar',1,'p_metachar','frontend_pythonre.py',233),
  ('metachar -> ALPHANUMERIC','metachar',1,'p_metachar','frontend_pythonre.py',234),
  ('metachar -> ALPHANUMERIC_COMPLEMENTED','metachar',1,'p_metachar','frontend_pythonre.py',235),
]
